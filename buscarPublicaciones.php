...
$conn = new  mysqli($localHost,$user,$pass,$basedatos);
if(mysqli_connect_error()){
    echo "fallo al conectar con MySQL: " . mysqli_connect_error();
    die();
}

$stmt = $conn->prepare("Select  tituloPublicacion, imagenPublicacion, contenidoPublicacion FROM tb_publicaciones ORDER BY idPublicacion desc");
$stmt->execute();
?>
