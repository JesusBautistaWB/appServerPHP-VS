...
$host="localHost";
	...
	try
	{
		...
		$bd->setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_EXCEPTION);
                $res= $bd->query("SELECT DISTINCT ES.Especialidad AS Especialidad
				...
				cat_especialidades ES Where S.ID_Dir = D.ID_Direccion AND S.Sucursal = T.Sucursal AND D.EDO = E.Catalog_Key 
				AND S.ID_Proveedor = P.Num_Proveedor AND R.ID_Especialidad = ES.ID_Especialidad  AND TipoServicio = 'C' 
